<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label for="categoryPageVideoUrlInput" class="text-capitalize">{{$category->name}} page video url</label>
                <input type="text" name="frontend_video_url" class="form-control" id="categoryPageVideoUrlInput"
                placeholder="Enter category title"  value="{{$category->frontend_video_url ?? old('frontend_video_url')}}" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="categoryPageVideoUrlInput" class="text-capitalize">{{$category->name}} page image one</label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="categoryPageVideoUrlInput" class="text-capitalize">{{$category->name}} page image two</label>
                <div class="custom-file">
