                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.subcategory.index', $category->slug)}}">{{$category->name}}
                                            </a>
                                        </td>
                                        <td>
                                            <form action="{{route('admin.category.destroy',$category->slug)}}"
                                                ...
                                                <button type="submit" title="delete" class="btn btn-danger btn-sm"
                                                    onclick="return confirm('Are you sure you want to delete this category ? All subcategories and thier products will also be deleted.')">
