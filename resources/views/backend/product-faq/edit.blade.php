            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('admin.product-faq.update', [$product->slug, $productFaq->id]) }}"
                            name="form" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                @include('backend.product-faq.form')
                            </div>
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Submit</button>
                                <a href="{{ route('admin.product-faq.index', $product->slug) }}" class="btn btn-danger">
