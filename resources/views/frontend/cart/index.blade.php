            ...
            <form action="{{route('frontend.cart.update')}}" method="POST">
                ...
                <tbody>
                    ...
                    <tr id="item-{{$item->id}}">
                        ...
                        <td>
                            <input type="number" id="item-{{$item->id}}-quantity" name="item[{{$item->id}}][quantity]"
                                value="{{$item->quantity}}">
                        </td>
                        <td>
                            <strong class="fw-500">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="submit" class="btn btn-black btn-block mt-4 text-dark bg-white">Update Cart
