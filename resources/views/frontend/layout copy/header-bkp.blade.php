    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse ">
            <div class="container-fluid">
                ...
                <a class="navbar-brand justify-content-center" href="{{route('frontend.home')}}">
                    <strong>{{ Setting::get('website_name') }}</strong>
                </a>
                ...
                <ul class="navbar-nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-menu-open menu-open" href="javascript:void(0)">
